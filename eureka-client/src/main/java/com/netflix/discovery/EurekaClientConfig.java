...
public interface EurekaClientConfig {
     ...
     * the eureka server.
     *
     *  从 Eureka-Server 拉取注册信息频率，单位：秒，默认30s
     *
     ...
     *
     * 向 Eureka-Server 同步实例对象信息变化频率，单位：秒 默认30s
     *
     ...
     *
     * 向 Eureka-Server 同步应用信息变化初始化延迟，单位：秒 默认40s
     *
     */
     ...
     * </p>
     *
     * 轮询获取 Eureka-Server 地址变更频率，单位：秒 默认5 * 60s
     *
     *
     ...
     * on client shutdown.
     *
     * 是否向 Eureka-Server 取消注册自身服务，当进程关闭时 默认true
     *
     ...
     *
     * 是否允许被 Eureka-Server 重定向，默认false
     *
     ...
     * </p>
     *
     * Eureka-Server 连接的空闲关闭时间，单位：秒 默认45s
     *
     ...
     *
     * 是否从 Eureka-Server 拉取注册信息 ，默认true
     *
     */
     ...
     *
     * 是否同步应用实例状态到 Eureka-Server，默认是true
     *
     */
